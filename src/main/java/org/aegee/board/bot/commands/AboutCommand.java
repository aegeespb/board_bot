...
public class AboutCommand {
    ...
    public void handleCallback(CallbackQuery callbackQuery) {
        ...
        if (chapter == AboutChapters.WHAT_TO_DO) {
            ...
            text = "AEGEE стремится к созданию демократической и разнообразной Европы, которая социально, экономически " +
                    ...
                    "активного участия в жизни общества. Миссией AEGEE является создание пространства для диалога, а также " +
                    "различных площадок для обучения и развития молодежи различных национальностей и профессий.";
            ...
            customReplyKeyboard = KeyboardsFactory.getWorkingGroupsAndEuropeanManagementAndBack();
        } else if (chapter == AboutChapters.LOCAL_WORKING_GROUPS) {
            text ="Работе Борда помогают Рабочие Группы (англ. Working Groups) — объединения по различным " +
                    "направлениям деятельности антенны." +
                    " В настоящий момент в AEGEE-Sankt-Peterburg функционируют пять рабочих групп:\n" +
            ...
            text = "<b>Европейский уровень</b>\n\n" +
                    ...
                    "\n\n" +
                    "Борд AEGEE называется Comité Directeur или попросту CD (рус. Руководящий Комитет). " +
                    "Это люди, для которых AEGEE становится полноценной работой, и они на целый год посвящают себя развитию организации." +
                    "\n\n" +
                    "Целый год CD живут и работают в штабе AEGEE в Брюсселе, а выбираются на Генеральной Ассамблее всея AEGEE — Агоре. " +
                    "Это большое собрание организации, в котором могут принимать участие от 600 до 1000 человек." +
                    " Подробнее про Агору прочесть можно в <a href=\"https://vk.com/@aegee_spb-agora\">нашей статье</a>." +
                    "\n\n" +
            ...
            customReplyKeyboard = KeyboardsFactory.officialMembershipPlusesAndBack();
        } else if (chapter == AboutChapters.OFFICIAL_MEMBERSHIP_PLUSES) {
            text ="<b>Преимущества официального членства</b>\n\n"+
            ...
            customReplyKeyboard = KeyboardsFactory.europeanEventsAndBack();
        } else if (chapter == AboutChapters.EUROPEAN_EVENTS) {
            text ="<b>Международные мероприятия</b>" +
                    "\n\n" +
    ...
    public enum AboutChapters {
        ...
        LOCAL_WORKING_GROUPS,
        EUROPEAN_MANAGEMENT_LEVEL,
        EUROPEAN_EVENTS, OFFICIAL_MEMBERSHIP_PLUSES
    }
}
